# AVR 8 MegaRF Platform Makefile
###############################################################################
...
CXXOBJ  = $(foreach file,$(CPPSRC:%.cpp=%.o),$(OBJDIR)/$(file))
AOBJ    = $(foreach file,$(ASRC:%.s=%.o),$(OBJDIR)/$(file))
OBJ		:= $(COBJ) $(CXXOBJ) $(AOBJ)
...
# Default lib target.
allib: begin gccversion sizebefore buildlib end
...
sizeafter:
	@if -f $(TARGET).elf; then echo; echo $(MSG_SIZE_AFTER); $(ELFSIZE); 2>/dev/null; echo; fi
